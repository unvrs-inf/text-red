				...
				<div className='bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-xl'>
					...
					<div className='flex items-center gap-3 mb-4'>
						<button
							...
							className='flex items-center gap-2 px-4 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-40 transition-colors text-gray-700 dark:text-gray-200'
						>
						...
						{testMessage && (
							<span
								className={`text-sm ${testStatus === 'ok' ? 'text-green-600 dark:text-green-400' : 'text-red-500'}`}
							>
								{testMessage}
							</span>
						)}
